...
* Full Page Screenshots: Captures entire scrolling articles.
...
* scripting: To scroll the page for screenshots and extract text.
* storage: To save settings locally.
* tabs & all_urls: Required for the floating button and screen capture on any site.
